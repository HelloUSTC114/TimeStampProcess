...
TCombinedData::TCombinedData(const PreCombinedData &Ini) : fDataTime(Ini.fDataTime), fDataCounter(Ini.fDataCounter), fLayerNumber(Ini.fLayerNumber),
...
TCombinedData::TCombinedData(const CombinedData &Ini) : TCombinedData(*Ini)
{
}
