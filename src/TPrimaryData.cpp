...
TPrimaryData::TPrimaryData(UChar_t Mac5, UShort_t *Chg, UInt_t Ts0, UInt_t Ts1, UInt_t Ts0_ref, UInt_t Ts1_ref, UInt_t Reset_Time, bool Clock_no) : mac5(Mac5), ts0(Ts0), ts1(Ts1), ts0_ref(Ts0_ref), ts1_ref(Ts1_ref), clock_no(Clock_no), reset_time(Reset_Time)
{
...
PrimaryDataPtr::PrimaryDataPtr(TPrimaryData *ptr) : sp(ptr)
{
}
