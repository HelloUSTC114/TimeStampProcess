...
public:
    TCombinedData(){fLayerFlags = NULL;fControlFlag=true;fMac5Array=NULL;}
    ...
    bool SetDataStartIndex(int primaryDataStartIndex){PrimaryDataStartIndex = primaryDataStartIndex; return true;}
